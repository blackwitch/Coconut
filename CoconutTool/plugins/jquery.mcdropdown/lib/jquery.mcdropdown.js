 ...
 */
	...
	browser.isIE = (str.indexOf('msie')!=-1 || (/\sTrident\/\d/i).test(window.navigator.userAgent));
	browser.isIE6 = (browser.isIE && $.browser.version && $.browser.version <= 6);
	...
	$.mcDropDownMenu = function(el, list, options){
		...
		if( browser.isIE || $.browser.safari) $self.bind("keydown", function (e){
