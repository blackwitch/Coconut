		...
		draw : function () {
			...
			if(this.$.data('skin') == 'tron') {
				...
				if (this.o.displayPrevious) {
					...
					this.g.arc(50, 50, this.radius - this.lineWidth, sa, ea, false);
					this.g.stroke();
				}
				this.g.beginPath();
				...
				this.g.stroke();
				//console.log(' draw End>>' + this.$.data('id') + ', xy >>' + this.xy + ', color ' + this.pColor + ',' + this.fgColor);
				return false;
			}
		}
	});
...
$(document).ready(function () {
	...
	if (ajax_url.length < 1) {
		ajax_url = 'ajax/control_box.html';
	}
